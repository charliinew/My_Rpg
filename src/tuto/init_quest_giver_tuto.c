...
const char *quest_giver_dial_tuto[] = {
    ...
    "You have earned a skill point that you can spend on a new skill.",
    "Open your inventory with the Tab key to access the skill menu.",
    ...
    "Practice using your new skill and return to me for further training.",
    "Your progress is impressive, recruit. Keep it up!",
    "",
    ...
    "To select a skill, open your inventory with the Tab key.",
    "Find the skill menu within the inventory.",
    ...
    "Practice using your new skill and return to me for further training.",
    "Mastering your abilities is key to becoming a true warrior.",
