...
const char *quest_giver_dial_tuto[] = {
    ...
    "return to me for further instruction.",
    ...
    "There are weakened goblins nearby",
    ...
    "This will test your ability",
    "to handle real combat situations.",
    ...
    "Search the area and",
    "gather everything the goblins left behind.",
    "Once you have collected all the items, return to me.",
    "This will teach you",
    "the importance of scavenging after battles.",
    ...
    "left-click on the mushroom to throw it away.",
    "This will teach you how to handle dangerous items.",
    "Once you have discarded the mushroom,",
    "close your inventory.",
    "",
    "Congratulations, recruit! You have leveled up.",
    "You have earned a skill point",
    "that you can spend on a new skill.",
    "Open your inventory with",
    "the Tab key to access the skill menu.",
    "In the skill menu, find the skill you want to unlock.",
    "You have three skills to choose from:",
    "1. Fireball: Unleash a powerful fireball.",
    "2. Run: Increase your movement speed.",
    "3. Shield: Create a protective barrier.",
    "Press the plus button (+) next to the skill to unlock it.",
    "Once the skill is unlocked, you can equip it.",
    "Click on the skill button to equip the unlocked skill.",
    "",
    "Congratulations, recruit. You have unlocked a new ability.",
    "You can now use special skills by pressing the Shift key.",
    "You can improve these skills using skill points.",
    "Earn skill points by leveling up.",
    "Gain experience by completing quests and defeating enemies.",
    "Practice using your new skill and",
    "return to me for further training.",
    "Mastering your abilities",
    "is key to becoming a true warrior.",
    "",
    ...
    "",
    "Fait une capture d'ecran j'y croirais pas.",
    NULL
};
